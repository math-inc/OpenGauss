...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Gauss Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Gauss Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
Gauss officially supports Linux, macOS, and WSL2. Native Windows is **not supported**, but the codebase includes some defensive coding patterns to avoid hard crashes in edge cases. Key rules:
