...
#
# Usage:
#   irm https://raw.githubusercontent.com/math-inc/OpenGauss/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:math-inc/OpenGauss.git"
$RepoUrlHttps = "https://github.com/math-inc/OpenGauss.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/math-inc/OpenGauss/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/math-inc/OpenGauss/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
